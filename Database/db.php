...
$products = [
    ...
    new AnimalProduct ('Cuccia per gatti', 15, 'https://www.gardenbedettishop.com/16593-large_default/cuccia-per-cani-queen-50-ferplast.jpg','mulo', new Category('product', 'bed', '3') ),
];
